...
@section('contenido')
                ...
                <!-- jquery validation -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Información Tabla Alimentación</h3>
                        </div>
                        <form class="forms-sample" action="{{ url('tabla_alimentacion',$tabla) }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2 form-group">
                                        ...
                                        <input type="text" name="pesos" class="form-control @error('pesos') is-invalid @enderror" id="peso" placeholder="Peso" maxlength="15" value="{{ $tabla->pesos }}" >
                                        @if ($errors->has('peso'))
                                    ...
                                    <div class="col-md-2 form-group">
                                        ...
                                        <input type="text" name="ta1" class="form-control @error('ta1') is-invalid @enderror" id="ta1" placeholder="TA1" maxlength="100" value="{{ $tabla->ta1 }}" >
                                        @if ($errors->has('ta1'))
                                            <div class="invalid-feedback" style="display: inline !important">
                                    ...
                                    <div class="col-md-2 form-group">
                                        ...
                                        <input type="text" name="ta3" class="form-control @error('ta3') is-invalid @enderror" id="ta3" placeholder="TA3" maxlength="100" value="{{ $tabla->ta3 }}" >
                                        @if ($errors->has('ta3'))
                                            <div class="invalid-feedback" style="display: inline !important">
                                    ...
                                    <div class="col-md-2 form-group">
                                        ...
                                        <input type="text" name="ta4" class="form-control @error('ta4') is-invalid @enderror" id="ta4" placeholder="TA4" maxlength="100" value="{{ $tabla->ta4 }}" >
                                        @if ($errors->has('ta4'))
                                            <div class="invalid-feedback" style="display: inline !important">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const inputs = [pesoInput, ta3Input, ta4Input, ta1Input];
            ...
            inputs.forEach(input => {
                ...
                if (!input.value) {
                    input.value = '0.00';  // Initialize fields to 0.00 if they are empty
                }
            });
        });
    </script>
